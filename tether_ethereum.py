# -*- coding: utf-8 -*-
"""
Created on Mon Apr  5 21:23:35 2021
...
# read csv file    
data = pd.read_csv("C:\\NUS\\Y2S2\\BT4014\\Final Project\\bt4014_project\\updated_crypto_data.csv")
...
# Tether Case
id = 'tether'
data_tether = data.drop(['XLM', 'ETH','NANO'], axis=1, inplace = False)
print(data_tether)
...
for column in focused_columns:
    ...
    plt.savefig("C:\\NUS\\Y2S2\\BT4014\\Final Project\\" + str(id)+'_tsplot_'+column+'.png')
    plt.show()
    plt.close()
...
for column in focused_columns:
    ...
    tsplot(data_tether[column], lags = 30)
    plt.savefig("C:\\NUS\\Y2S2\\BT4014\\Final Project\\" + str(id)+'_tsplot_log_'+column+'.png')
    plt.show()
    plt.close()
...
for column in focused_columns:
    ...
    plt.savefig("C:\\NUS\\Y2S2\\BT4014\\Final Project\\" + str(id)+'_tsplot_diff_'+column+'.png')
    plt.show()
    plt.close()
...
# order 10 is the best lag order
results = tether_model.fit(10, trend="c")
results_file = "C:\\NUS\\Y2S2\\BT4014\\Final Project\\" + str(id)+'_results_lag'+str(10)+'.txt'
structural_file = "C:\\NUS\\Y2S2\\BT4014\\Final Project\\" + str(id)+'_lag'+str(10)
...
# Ethereum Case
id = 'ethereum'
data_eth = data.drop(['XLM', 'USDT','NANO'], axis=1, inplace = False)
print(data_eth)
...
# order 15 is the best lag order
results = eth_model.fit(15,trend="c")
results_file = "C:\\NUS\\Y2S2\\BT4014\\Final Project\\" + str(id)+'_results_lag'+str(15)+'.txt'
structural_file = "C:\\NUS\\Y2S2\\BT4014\\Final Project\\" + str(id)+'_lag'+str(15)
